...
export class ReferralPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.text = 'Hi, BrightHubpro is the app, when it comes to approaching and selling  to new prospects! Here\'s the quick intro on your phone and use this link to directly get the app now!\n';
    this.text2 = 'Hi Introducing the most generous loyalty program ever and it\'s included with the extra convenience of Flownet! Up to 30% back in cash, here\'s the details: Get on BrightHubpro today and start making money now!\n';
    this.text3 = 'Hi , I joined a company called BrightHubpro, a friend recommended to me and I am so thankful! Here’s a snapshot of what it looks like, when I watched it, I thought of you so figured I’d share the quick intro.There is a short video. It’s worked well for me and might for you too. I’ll call you this weekend and we can discuss how this can help you in a time like this. Stay healthy and safe out there.\n';
  }
